...
/**
 * Private helper function that is used to initialize permissions for the script.
 */
...
function getMarketJson(itemId, regionId, orderType)
{
  ...
  else
  {
    ...
    //               https://esi.tech.ccp.is/latest/markets/10000002/orders/?order_type=all&type_id=44992
